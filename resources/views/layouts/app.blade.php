...
<head>
    ...
    <title>@if ( $pageTitle != NULL ) {{ $pageTitle }} | @endif Tam Tour & Travel </title>
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="pull-right hidden-xs">
                <b><a href="https://www.tammanager.com" target="_blank">Tam Tour & Travel</a> {{Lang::get('core.version')}}</b> 1.0.0
            </div>
